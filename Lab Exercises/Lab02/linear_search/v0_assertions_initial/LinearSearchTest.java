 ...
 * Tests LinearSearch.search using Assertions.
 *
 ...
 */
 ...
 public final class LinearSearchTest {
   ...
   public static void main(String[] args) {
     LinearSearchTest tester = new LinearSearchTest();
     tester.testSearch_lengthN_unique_found_front();
     tester.testSearch_lengthN_unique_found_mid();
     tester.testSearch_lengthN_unique_found_rear();
   }
...
/********************************************************************/
   ...
   private void coreTest(int[] a, int target, int expected) {
     ...
     assert (expected == actual) : feedback.toString();
   }
